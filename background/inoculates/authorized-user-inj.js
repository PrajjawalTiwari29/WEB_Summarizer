...
container.innerHTML = `<div class="gpts-user-authorized-dialog">
                                ...
                                <b class="unthinkable">Authorization successful</b>
                                <p class="unthinkable">Do not exit this page and return to the <span class="gpts-return-page">previous page</span>.
                                </p>
                            </div>`;
